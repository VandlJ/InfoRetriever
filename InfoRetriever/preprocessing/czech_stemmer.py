...
def cz_stem(text_input, aggressive=False):
    if isinstance(text_input, str):
        return cz_stem_word(text_input)
    else:
        return [cz_stem(w) for w in text_input if w]
...
if __name__ == '__main__':
    ...
    for line in sys.stdin:
        print(" ".join([cz_stem(word, aggressive=aggressive)
